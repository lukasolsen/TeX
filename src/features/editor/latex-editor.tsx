...
function sourceEditorTheme(fontSize: number) {
  return EditorView.theme({
    ...
    ".tex-completion-kind-command": {
      color: "var(--primary)",
      borderColor: "color-mix(in oklch, var(--primary) 40%, var(--border))",
      backgroundColor: "color-mix(in oklch, var(--primary) 12%, transparent)",
    },
    ".cm-tooltip-autocomplete > ul > li[aria-selected] .tex-completion-kind": {
      color: "var(--accent-foreground)",
      borderColor: "color-mix(in oklch, var(--accent-foreground) 40%, transparent)",
      backgroundColor: "color-mix(in oklch, var(--accent-foreground) 14%, transparent)",
    },
    ".cm-completionInfo": {
      minWidth: "18rem",
      maxWidth: "24rem",
